...
public class DataLoader implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                Cliente cliente1 = clienteRepository.save(new Cliente("Daniel", "Cedeño",
                                "cedeno.danielc@javeriana.edu.co", "1234567", "3106699555", "Calle 45 #7-95", true));
                Cliente cliente2 = clienteRepository.save(new Cliente("Jose", "Pulido", "jose.p@javeriana.edu.co",
                                "5678923", "3113479585", "Calle 98 #8-45", true));
                Cliente cliente3 = clienteRepository.save(new Cliente("Sebastián", "Rincón",
                                "rincon.sebas@javeriana.edu.co", "123", "3112549855", "Calle 100 #4-35", true));
                ...
                Cliente cliente5 = clienteRepository.save(new Cliente("Giovanny", "Durán",
                                "gio.duran_@javeriana.edu.co", "1236547", "3057789635", "Calle 40 #7-90", true));
                Cliente cliente6 = clienteRepository.save(new Cliente("Diego", "Melgarejo", "diegui200@gmail.com",
                                "1233377", "3177799950", "Calle 80 #13-43", true));
                ...
                Cliente cliente8 = clienteRepository.save(new Cliente("Laura", "Corvacho",
                                "corvacho.laura_xx@gmail.com", "9876543", "3096789500", "Calle 200 #15-90", true));
                Cliente cliente9 = clienteRepository.save(new Cliente("Juan", "vil", "vil_juan_2005@gmail.com",
                                "7799881", "3145533789", "Calle 150 #9-50", true));
                Cliente cliente10 = clienteRepository.save(new Cliente("Sebastián", "Angarita",
                                "angarita.sebastian@yahoo.com", "5554445", "3143224455", "Calle 24b #5-75", true));
                ...
                productoRepository.save(new Producto("Cerveza", 12000,
                                "Cerveza fría perfecta para acompañar comidas y momentos especiales.",
                ...
                productoRepository.save(new Producto("Jugo de lulo", 14000,
                                ...
                                "https://img.postershop.me/22622/a972bd6a-1273-4ae2-9850-d40848dda99a_image.jpeg", true,
                                bebidas));
                ...
                Domiciliario domiciliario2 = domiciliarioRepository.save(
                                new Domiciliario("Juancho rodriguez", "3234560090", "0000129393", true, operador2));
