...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Cliente cliente1 = clienteRepository.save(new Cliente("Daniel", "Cedeño", "cedeno.danielc@javeriana.edu.co",
                "1234567", "3106699555", "Calle 45 #7-95", true));
        Cliente cliente2 = clienteRepository.save(new Cliente("Jose", "Pulido", "jose.p@javeriana.edu.co", "5678923",
                "3113479585", "Calle 98 #8-45", true));
        Cliente cliente3 = clienteRepository.save(new Cliente("Sebastián", "Rincón", "rincon.sebas@javeriana.edu.co",
                "1234", "3112549855", "Calle 100 #4-35", true));
        Cliente cliente4 = clienteRepository.save(new Cliente("Eileen", "Rodriguez",
                "eileen.rodriguez@javeriana.edu.co", "1234900", "3100076895", "Calle 129 #9-42", true));
        Cliente cliente5 = clienteRepository.save(new Cliente("Giovanny", "Durán", "gio.duran_@javeriana.edu.co",
                "1236547", "3057789635", "Calle 40 #7-90", true));
        Cliente cliente6 = clienteRepository.save(new Cliente("Diego", "Melgarejo", "diegui200@gmail.com", "1233377",
                "3177799950", "Calle 80 #13-43", true));
        Cliente cliente7 = clienteRepository.save(new Cliente("Karen", "Colmenares", "karencol07_@hotmail.com",
                "7843567", "3195054045", "Calle 127 #5-35", true));
        Cliente cliente8 = clienteRepository.save(new Cliente("Laura", "Corvacho", "corvacho.laura_xx@gmail.com",
                "9876543", "3096789500", "Calle 200 #15-90", true));
        Cliente cliente9 = clienteRepository.save(new Cliente("Juan", "vil", "vil_juan_2005@gmail.com", "7799881",
                "3145533789", "Calle 150 #9-50", true));
        Cliente cliente10 = clienteRepository.save(new Cliente("Sebastián", "Angarita", "angarita.sebastian@yahoo.com",
                "5554445", "3143224455", "Calle 24b #5-75", true));

        /* Productos */

        Producto producto1 = productoRepository.save(new Producto("berenjenas a la parmesana", 40000,
        ...
        Producto producto2 = productoRepository.save(new Producto("Burrata", 45000,
        ...
        Producto producto3 = productoRepository.save(new Producto("carpaccio di salmone", 60000,
        ...
        Producto producto4 = productoRepository.save(new Producto("papas a la Francesa", 25000,
        ...
        Producto producto5 = productoRepository.save(new Producto("pasta gratinada del chef", 50000,
        ...
        Producto producto6 = productoRepository.save(new Producto("polpo alla griglia", 50000,
        ...
        productoRepository.save(new Producto("Fiori di Zucca", 32000,
        ...
        productoRepository.save(new Producto("Crema di pomodoro", 24000,
        ...
        productoRepository.save(new Producto("Carbonara di mare", 48000,
        ...
        productoRepository.save(new Producto("Alfredo con camarones", 46000,
        ...
        productoRepository.save(new Producto("Pasta sofia loren", 38000,
        ...
        productoRepository.save(new Producto("Arrabiata", 34000,
        ...
        productoRepository.save(new Producto("Pesto e pistacchio", 42000,
        ...
        productoRepository.save(new Producto("Salmone alla griglia", 58000,
        ...
        productoRepository.save(new Producto("Atún speciale", 56000,
        ...
        productoRepository.save(new Producto("Lomo a la parrilla", 62000,
        ...
        productoRepository.save(new Producto("Quatro Formaggi E Mirtilli", 44000,
        ...
        productoRepository.save(new Producto("Polpete D'amore", 42000,
                "Albóndigas italianas elaboradas con carne seleccionada, acompañadas de salsa de tomate tradicional y sabores mediterráneos.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/88ee35c5-6c0b-4b91-aecf-2a2a08843e8a.webp",
                true, entradas));

        productoRepository.save(new Producto("Carpaccio di Manzo Tartufato", 58000,
                "Finas láminas de res acompañadas de aceite de oliva, queso parmesano y un delicado toque de trufa.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/85176223-2fe4-441b-89fa-c1f876ed23ce.webp",
                true, entradas));

        productoRepository.save(new Producto("Prosciutto Di Parma", 52000,
                "Jamón italiano tradicional servido con acompañamientos frescos y una presentación clásica mediterránea.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/fb2f19e0-5ae0-4cf3-9b99-e47b79118ca8.webp",
                true, entradas));

        productoRepository.save(new Producto("Kale Cesare", 32000,
                "Ensalada fresca de kale con aderezo César, queso parmesano y complementos seleccionados.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/113b3503-604f-4706-a9aa-fe59a1829d53.webp",
                true, ensaladas));

        productoRepository.save(new Producto("Gamberi Alla Vodka", 56000,
                "Camarones preparados en una cremosa salsa de vodka con sabores italianos y acompañamiento especial.",
        ...
        productoRepository.save(new Producto("New York Funghi", 46000,
                "Pizza con variedad de hongos, queso mozzarella y sabores intensos inspirados en la cocina italiana.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/18442977-6b08-49ff-bf0b-0da9e4cc5dca.webp",
                true, pizzas));

        productoRepository.save(new Producto("Ragú Toscano", 52000,
                "Pasta tradicional con salsa ragú preparada al estilo toscano con carne y especias italianas.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/321935df-17e1-4dcb-ab49-0b53cc217e51.webp",
                true, pastas));

        productoRepository.save(new Producto("Asado de Tira Alla Toscana", 75000,
                "Corte de carne cocinado lentamente al estilo italiano, acompañado de sabores tradicionales de la Toscana.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/9e8b4993-29ef-48d9-a573-a679811dd80e.webp",
                true, carnes));

        productoRepository.save(new Producto("Ragú de Ossobuco", 68000,
                "Preparación italiana de ossobuco cocinado lentamente con salsa rica en aromas y sabores profundos.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/58ad402b-361e-45e9-9dce-742b3808626f.webp",
                true, carnes));

        productoRepository.save(new Producto("Picanha Steak", 79000,
                "Corte de picanha preparado a la parrilla, conservando su jugosidad y sabor característico.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/d62c4945-743e-41da-a4c9-b9b99bbfe968.webp",
                true, carnes));

        productoRepository.save(new Producto("Besos con Propósito", 42000,
                "Postre especial de la casa con combinación de texturas dulces y una presentación sofisticada.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/aea0a96b-a4b8-445f-b1b3-543aed34640b.webp",
                true, postres));

        productoRepository.save(new Producto("Tiramisú Tradicional", 30000,
                "Postre italiano clásico preparado con café, crema de mascarpone y cacao.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/e6e5007d-cca0-44d5-b568-8677ed6863f1.webp",
                true, postres));

        productoRepository.save(new Producto("Brownie con Gelato", 32000,
                "Brownie de chocolate acompañado con helado, creando una combinación de sabores y temperaturas.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/2f7b1089-575e-4dcc-b7a4-c788b4da6ba1.webp",
                true, postres));

        productoRepository.save(new Producto("Dolce Storia D'Amore", 38000,
                "Postre insignia con una mezcla de sabores dulces y una presentación inspirada en la cocina italiana.",
                "https://dvzwo3mu4ucsq.cloudfront.net/images/restaurants/storiadamore/product/c823653f-d363-4c8f-844e-a26365786a10.webp",
                true, postres));

        productoRepository.save(
                new Producto("Coca Cola", 8000, "Bebida gaseosa fría ideal para acompañar cualquier plato del menú.",
                        "https://i.pinimg.com/736x/b8/c9/35/b8c93542014b2d12d4f778ef312e2bf3.jpg", true, bebidas));

        productoRepository.save(new Producto("Jarra de limonada", 18000,
                "Limonada fresca preparada con limón natural, hielo y un toque refrescante.",
                "https://thumbs.dreamstime.com/b/jarra-de-limonada-con-rodajas-lim%C3%B3n-primer-plano-y-menta-sobre-una-mesa-madera-fondo-rural-escena-218289142.jpg",
                true, bebidas));

        productoRepository.save(
                new Producto("Cerveza", 12000, "Cerveza fría perfecta para acompañar comidas y momentos especiales.",
                        "https://cdn.pixabay.com/photo/2018/11/08/22/12/beer-3803425_640.jpg", true, bebidas));

        productoRepository.save(new Producto("Jugo de fresa", 14000,
                "Jugo natural de fresa preparado con fruta fresca y servido frío.",
                "https://images.pexels.com/photos/31578583/pexels-photo-31578583/free-photo-of-coctel-refrescante-de-fresa-con-cubitos-de-hielo.jpeg?cs=tinysrgb&dpr=1&w=500",
                true, bebidas));

        productoRepository.save(new Producto("Jugo de lulo", 14000,
                "Jugo natural de lulo con sabor tropical y refrescante.",
                "https://img.postershop.me/22622/a972bd6a-1273-4ae2-9850-d40848dda99a_image.jpeg", true, bebidas));
        ...
        Domiciliario domiciliario1 = domiciliarioRepository
                .save(new Domiciliario("Juls Caicedo", "3056677848", "0000238282", true, operador1));
        Domiciliario domiciliario2 = domiciliarioRepository
                .save(new Domiciliario("Juancho rodriguez", "3234560090", "0000129393", true, operador2));
        Domiciliario domiciliario3 = domiciliarioRepository
                .save(new Domiciliario("Esteban Bogotá", "3223388848", "0000443382", true, operador3));
        Domiciliario domiciliario4 = domiciliarioRepository
                .save(new Domiciliario("Pablo Rincón", "3056677859", "0000255722", true, operador4));
        Domiciliario domiciliario5 = domiciliarioRepository
                .save(new Domiciliario("Julian España", "3056637890", "0000123321", true, operador5));
        ...
        Pedido pedido1 = pedidoRepository.save(new Pedido("Entregado", LocalDateTime.now().minusMinutes(30),
                LocalDateTime.now(), cliente1, operador1, domiciliario1));

        Pedido pedido2 = pedidoRepository.save(new Pedido("Cocinando", LocalDateTime.now().minusMinutes(50),
                LocalDateTime.now(), cliente2, operador2, domiciliario2));

        Pedido pedido3 = pedidoRepository.save(new Pedido("Enviado", LocalDateTime.now().minusMinutes(20),
                LocalDateTime.now(), cliente3, operador3, domiciliario3));

        Pedido pedido4 = pedidoRepository.save(new Pedido("Recibido", LocalDateTime.now().minusMinutes(40),
                LocalDateTime.now(), cliente4, operador4, domiciliario4));
