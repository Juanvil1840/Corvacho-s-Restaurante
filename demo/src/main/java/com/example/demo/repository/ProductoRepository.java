...
public class ProductoRepository {
        ...
        private AtomicLong idGenerator = new AtomicLong(21L); //El generador de ids empieza en 21, ya que tenemos 20 platos en memoria 
        ...
        public ProductoRepository() { //Agregamos los platillos con su nombre, precio, descripcion, imagen, si estan dispobibles, ingredientes y categorias
                data.put(1L, new Producto(1L, "berenjenas a la parmesana", 40000.0,
                ...
                data.put(2L, new Producto(2L, "Burrata", 45000.0,
                ...
                data.put(3L, new Producto(3L, "carpaccio di salmone", 60000.0,
                ...
                data.put(4L, new Producto(4L, "papas a la Francesa", 25000.0,
                ...
                data.put(5L, new Producto(5L, "pasta gratinada del chef", 50000.0,
                ...
                data.put(6L, new Producto(6L, "polpo alla griglia", 50000.0,
                ...
                data.put(7L, new Producto(7L, "Fiori di Zucca", 32000.0,
                ...
                data.put(8L, new Producto(8L, "Crema di pomodoro", 24000.0,
                ...
                data.put(9L, new Producto(9L, "Ensalada mediterranea", 28000.0,
                ...
                data.put(10L, new Producto(10L, "Carbonara di mare", 48000.0,
                ...
                data.put(11L, new Producto(11L, "Alfredo con camarones", 46000.0,
                ...
                data.put(12L, new Producto(12L, "Pasta sofia loren", 38000.0,
                ...
                data.put(13L, new Producto(13L, "Arrabiata", 34000.0,
                ...
                data.put(14L, new Producto(14L, "Pesto e pistacchio", 42000.0,
                ...
                data.put(15L, new Producto(15L, "Salmone alla griglia", 58000.0,
                ...
                data.put(16L, new Producto(16L, "Atún speciale", 56000.0,
                ...
                data.put(17L, new Producto(17L, "Milanesa gratinada", 44000.0,
                ...
                data.put(18L, new Producto(18L, "Lomo a la parrilla", 62000.0,
                ...
                data.put(19L, new Producto(19L, "Pepperoni", 38000.0,
                ...
                data.put(20L, new Producto(20L, "Quatro Formaggi E Mirtilli", 44000.0,
